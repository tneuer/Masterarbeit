...
elif compare_to == "cGAN":
    generated_images_comparison = generated_images_cgan
else:
    raise ValueError("compare_to must be 'Direct' or 'cGAN'.")
...
# labels = ["Geant4", compare_to, "Im2Im"]
...
# plt.savefig(savefolder+"/im2im_energy_{}.png".format(compare_to), dpi=200)
...
#         continue
#     print(calo_max, im2im_max, direct_max)
#     print((calo_max-im2im_max)/calo_max, (calo_max-direct_max)/calo_max)
...
#     set_title_for(ax=axs[1], im=generated_images_cgan[i], name="cGAN")
...
#     set_title_for(ax=axs[3], im=generated_images_im2im[i], name="Image-to-Image")
#     axs[4].imshow(generated_images_direct[i], vmin=0, vmax=max_e)
#     set_title_for(ax=axs[4], im=generated_images_direct[i], name="Direct Tracker-to-Calorimeter")
...
#     if "Image" in f:
#         this_data["Method"] = "Im2Im"
#     elif "Vector" in f:
#         this_data["Method"] = "cGAN"
#     elif "Direct" in f:
#         this_data["Method"] = "Direct"
#     else:
...
# colors = {"cGAN": "orange", "Im2Im": "green", "Direct": "blue"}
...
# plt.savefig("../../Thesis/figures/Results/timing.png", dpi=300)
