...
####################################################################################
    ...
    # Creation Date : 2019-11-21 20:45:25
    # Description :
####################################################################################
"""
import time
...
if __name__ == '__main__':
    ...
    z_dim = 64
    label_dim = 10
    cc_cwgan = CC_CWGAN1(x_dim=inpt_dim, y_dim=label_dim, z_dim=z_dim, last_layer_activation=tf.nn.sigmoid,
                  gen_architecture=gen_architecture, critic_architecture=critic_architecture, aux_architecture=aux_architecture,
                  folder="../../Results/Test/CC_CWGAN1", image_shape=image_shape, append_y_at_every_layer=True)
