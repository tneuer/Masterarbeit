...
class CVAEGAN(Image2ImageGenerativeModel):
    def __init__(self, x_dim, y_dim, z_dim, enc_architecture, gen_architecture, disc_architecture, folder="./CVAEGAN"):
        super(CVAEGAN, self).__init__(x_dim, y_dim, [enc_architecture, gen_architecture, disc_architecture], folder)
...
if __name__ == '__main__':
    ...
    disc_architecture = [
                        ...
                        [conv2d_logged, {"filters": 32, "kernel_size": 4, "strides": 2, "activation": tf.nn.sigmoid, "padding": "same"}],
                        [conv2d_logged, {"filters": 64, "kernel_size": 4, "strides": 2, "activation": tf.nn.sigmoid, "padding": "same"}],
                        ]
    ...
    print(cvaegan._discriminator.get_number_params())
    ...
    cvaegan.compile(learning_rate=learning_rate, optimizer=tf.train.AdamOptimizer, lmbda=lmbda)
