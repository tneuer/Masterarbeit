...
class BiCycleGAN(Image2ImageGenerativeModel):
    def __init__(self, x_dim, y_dim, z_dim, enc_architecture, gen_architecture, adversarial_architecture, folder="./BiCycleGAN",
        ...
        self._gen_input = image_condition_concat(inputs=self._X_input, condition=self._output_enc, name="real")
    ...
    def compile(self, loss, optimizer, learning_rate=None, learning_rate_enc=None, learning_rate_gen=None, learning_rate_adv=None,
                label_smoothing=1, lmbda_kl=1, lmbda_y=1, lmbda_z=1, feature_matching=False):
        ...
        self._define_loss(loss=loss, label_smoothing=label_smoothing, lmbda_kl=lmbda_kl, lmbda_y=lmbda_y,
                          lmbda_z=lmbda_z, feature_matching=feature_matching)
    ...
    def _define_loss(self, loss, label_smoothing, lmbda_kl, lmbda_y, lmbda_z, feature_matching):
...
if __name__ == '__main__':
    ...
    for params in sampled_params:
        ...
        compile_params = {
            ...
            "feature_matching": feature_matching, "label_smoothing": label_smoothing
